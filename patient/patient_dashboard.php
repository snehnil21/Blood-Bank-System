...
<body>
<div class="login-page bk-img"  style="background-image: url(img/b1.jpeg);  background-size: cover; background-repeat: no-repeat;">
    <nav class="navbar bg-danger">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" style="color: white;" href="index.php">E-Blood Bank </a>
            </div>
