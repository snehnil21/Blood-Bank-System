...
<div class="col-md-3 content-right">
            <img class="img-fluid" src="../BBMS/images/im1.png" height="auto" width="70%">
        </div>
    <div class="container">
        <div class="row">
            <div class="col-md-8 m-auto" id="certificate">
                ...
                <div class="certificate-footer">
                    <p>Jijai Blood Bank<a href="#" target="_blank"><i class="fab fa-facebook"></i></a> | <a href="#" target="_blank"><i class="http://www.jijaibloodcentre.in/"></i></a></p>
                </div>
            </div>
        </div>
    </div>
